...
educationRouter.get(
  ...
  async (req, res, next) => {
    try {
      ...
      const foundUserEducations = await Education.findEducationsByUserId(
        userId
      );
...
educationRouter.put(
  ...
  async (req, res, next) => {
    try {
      ...
      const updatedEducation = await EducationService.modifyEducation(
        currentUserId,
        eduId,
        updatedEduData
      );
...
educationRouter.delete(
  ...
  async (req, res, next) => {
    try {
      ...
      const deletedEducation = await EducationService.removeEducation(
        currentUserId,
        eduId
      );
