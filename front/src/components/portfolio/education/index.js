...
import FieldDocumentBlock, { FieldListBlock } from "../common/FieldListBlock";
import { postDocument, updateDocument } from "../../../services/documentApi";
...
const Education = ({ user }) => {
  ...
  return (
    ...
    >
      ...
      {!isAdding && <ShowItem isAdding={isAdding} setIsAdding={setIsAdding} />}
    </FieldListBlock>
  );
};
...
const ShowItem = ({
  ...
  async function handleSubmit(e) {
    ...
    if (isAdding) {
      ...
      postDocument(fieldName, content, userId, setIsAdding, setDatas);
    } else {
      updateDocument(
        data._id,
        fieldName,
  ...
  if (isDocumentEditing || isAdding) {
    return (
      <FieldDocumentBlock setDatas={setDatas} fieldName={fieldName} data={data}>
